...
Для начала следует выбрать нужное блюдо (во вкладке ИЗМЕНИТЬ ВЕС ПРОДУКТОВ) и в поле "умножить" ввести МАМУ. После во вкладке ВЫГРУЗКА / УДАЛЕНИЕ ОТЧЕТА можно посмотреть сколько было потрачено продуктов и данные сохранить в файл.
